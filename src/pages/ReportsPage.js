...
// --- Report options with Icons (Request 5) ---
            ...
            <div className="glass-card report-form-container">
                <form onSubmit={onGenerate}>
                    <div className="generate-report-grid">
                        ...
                        {/* Right: Report type dropdown + Generate (Requests 2 & 4) */}
                        <div className="report-actions-container">

                            {/* Request 2: Label beside dropdown */}
                                    ...
                                    >
                                        {REPORT_TYPES.map((t) => (
                                            <li key={t}>
                                                <button
                                                    type="button"
                                                    // Request 3: Class for hover style
